...
def get_main_args():
  ...
  parser.add_argument('--load',dest='dump', help='load a dataset dump',default='../data/stanford_cmn_refcocog_iou05.triplets.pkl')
  ...
  parser.add_argument('--model',dest='model', help='model type cmn|groundnet, default:groundnet', default = 'groundnet')
  ...
  parser.add_argument('--lr-decay',dest='lr_decay',help='learning rate decay, default = 0.5',default = 0.5, type = float)
...
def get_cmn_imbd():
  ...
  parser.add_argument('--imdbs',dest='imdbs',help="imdbs for headp perturbation '' or '{PATH TO IMDB}/imdb_trn.npy {PATH TO IMDB}/imdb_val.npy' default=''",default='')
